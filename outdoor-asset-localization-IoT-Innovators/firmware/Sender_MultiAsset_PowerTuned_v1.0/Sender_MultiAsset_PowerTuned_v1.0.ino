...
// ================= Multi-Asset Config =================
// The sender will switch between these asset IDs over time.
// This is used to test realistic multi-asset handling through the real LoRa/MQTT/Firebase pipeline.
...
// For testing/demo, 30 seconds is useful.
...
void setup() {
  ...
  Serial.println();
  Serial.println("====================================");
  Serial.println("GPS + LoRa Multi-Asset Sender");
  Serial.println("Mode: No OLED / Dynamic Asset IDs");
